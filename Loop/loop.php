<?php
/* foreach - is a logical structure called a loop. Loops are used whenever an instruction (or a series of instructions) need to be repeated several times. 
1.
...
Then, modify your loop so as to conjugate the verb "to code" in the present tense. Use a <br> to go to the next line. The result should be :I code
You code
He/She codes
We code
You code
...
//--------Sample Explanations about while and for loop----------
/* ------------- While ----------------
...
*/
// -----------------Exercises-----------------
// 1. Write a script that prints the numbers from 1 to 120 using  while
...
// 2. Write a script that prints the numbers from 1 to 120 using  for

for ($values = 1; $values <= 120; $values++){
  echo $values.'<br/>';
}

// 3. Create an array containing the firstname of everyone in your startup. Display each firstname using a loop.

$firstName = array('Saranya','Om','Hanissh');
foreach ($firstName as $myNames){
  echo '<p>'.$myNames .'</p>';
}

// 4. Create an array containing at least 10 countries. Then, generate the html that will render a select box inside an html form (see mockup below). Of course, a loop will be useful...

$countries = array('India', 'France', 'Luxembourg', 'Allemagne', 'Hollande', 'Espagne', 'Portugual', 'Suisse', 'Danemark', 'Lituanie', 'Pologne'); 
...
echo '<br/>';
echo '<br/>';
// 5 & 6. Now, edit your array so that it becomes an associative array: use the country ISO code as array key, and the country name as value. For example :
$countries = array(
  'IN' => 'India',
  'BE' => 'Belgique', 
  'FR' => 'France', 
